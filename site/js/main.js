...
function hideButton(){
    $("#place-order-button").css("visibility","hidden");
}


function showButton(){
    $("#place-order-button").css("visibility","visible");
}
    ...
    $.getJSON('content/products.json', function (data) {
        ...
        $.each(data, function (key, val) {
            ...
            var listItem = 
                '<li>' +
                    '<a href="#">' +
                        '<img src="content/assets/productImages/' + orderLineItem.product.image + '" alt="'+orderLineItem.product.name+ '"/>' + 
